...
$listings = [
  [
    ...
    'tags' => ['Digital Marketing','Software Development', 'Java', 'Python']
  ],
  [
    'id' => 2,
...
function highlihtTags($tags, $searchTerm)
{
      ...
      <div class="md my-4">
        <div class="rounded-lg shadow-md <?= $index % 2 === 0 ? 'bg-blue-100' : 'bg-white' ?>">
          <div class="p-4">
            ...
            <ul class="mt-4">
              <li class="mb-2">
                <strong>Salary:</strong> <?= formatMoney($job['salary']) ?>
              </li>
              <li class="mb-2">
              ...
              <?php if (!empty($job['tags'])) : ?>
                <li class="mb-2">
                  <strong>Tags:</strong> <?= highlihtTags($job['tags'], 'Digital Marketing') ?>
                </li>
              <?php endif; ?>
            </ul>
          </div>
